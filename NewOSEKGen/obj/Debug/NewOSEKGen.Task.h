...
extern StatusType ActivateTask
(
	TaskType TaskID
);
extern void RemoveTask(TaskType TaskID);
extern TaskType GetNextTask
(
	void
);
extern StatusType GetTaskID
(
	TaskRefType TaskID
);
 ...
 **/
#define JmpTask(task) setcontext(TasksConst[(task)].TaskContext)

#endif /* #define _TASKS_ */
